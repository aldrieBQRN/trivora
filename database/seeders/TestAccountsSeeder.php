        ...
        foreach ($todaDriversConfig as $cfg) {
            ...
            $tricycle = Tricycle::updateOrCreate(
                ...
                [
                    ...
                    // $cfg['coding'] is this unit's 4-digit Sticker Number — the config key
                    // was still called 'body' back when the value was labelled a Body Number.
                    // Same number, updated terminology; the value itself never changed.
                    'coding_scheme_number' => $cfg['coding'],
                    'engine_number'        => 'ENG-' . $cfg['coding'],
                    'chassis_number'       => 'CHS-' . $cfg['coding'],
                    'make'                 => $cfg['make'],
