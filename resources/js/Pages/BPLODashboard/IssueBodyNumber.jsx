...
export default function IssueBodyNumber({ application }) {
    ...
    const handleFinalize = (e) => {
        ...
        Swal.fire({
            ...
            html: `Are you sure you want to finalize the registration and assign Smart GPS Tracker <b>${data.tracker_id}</b> to Body Number <b>${data.body_number}</b>?`,
            icon: 'warning',
                ...
                post(`/bplo/issue/${application.id}`, {
                    onSuccess: () => {
                        Swal.fire({
                            ...
                            text: `Body Number ${data.body_number} is now active.`,
                            icon: 'success',
