...
// pages/shared components (see KpiCard.jsx / DataTable.jsx), so this page's form card reads as
        ...
        <TrivoraLayout title="File Violation Ticket" role="TMO Officer">
            ...
            <div className="mx-auto max-w-2xl">
                <PageHeader
                    ...
                    title="File Violation Ticket"
                />

                <form onSubmit={handleSubmit} className={`rounded-2xl border border-tmo-border/70 bg-tmo-surface p-7 ${CARD_SHADOW}`}>
                    ...
                    <div className="mt-8 flex justify-end gap-3 border-t border-tmo-border pt-6">
                        ...
                        >
                            {processing ? 'Logging Ticket...' : 'Record Violation Ticket'}
                        </Button>
                    </div>
                </form>
            </div>
