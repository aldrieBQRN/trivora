...
import {
    ...
    CheckSquare, Bike, ShieldAlert
} from 'lucide-react';

/* ─────────────────────────────────────────────────────────────────────────
   TMO COMMAND — Enterprise light theme (Centered Logo)
   Fonts  : Plus Jakarta Sans (display) · Inter (UI) · DM Sans (labels)
   Palette: Slate-white · Deep navy-indigo · Bright indigo accent
───────────────────────────────────────────────────────────────────────── */
const CSS = `
...
.t-menu-btn.desktop { display: none; }
@media (min-width: 1024px) { .t-menu-btn.desktop { display: flex; } }
                    ...
                    <header className="t-header">
                        ...
                        <div className="t-header-right">
                            ...
                            <div className="t-profile">
                                ...
                                >
                                    <div className="t-avatar">TM</div>

                                    <div className="t-pinfo">
                                        <p className="t-pname">{role}</p>
                                        <p className="t-psub">Authorized</p>
                                    </div>
                                ...
                                {profileOpen && (
                                    <div className="t-dropdown">
                                        <div className="t-dd-head">
                                            <p className="t-dd-label">Management</p>
                                            <p className="t-dd-name">Administrator</p>
                                        </div>
